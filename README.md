...
## Installing the SDK
- Download the remitabiller-sdk-dotnet-master.zip package into a directory of your choice.
- Extract the zip file to a folder/directory e.g. remitabiller-sdk-dotnet.
- Within Visual Studio click on File > Open > Project/Solution browse to the extracted folder then select the  RemitaBillingGatewayNuget.csproj and click open.
